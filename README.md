...
### **Summary**
Senior Backend Developer with over 10 years of experience in architecting and implementing scalable distributed systems. Expert in **Go** and **Python**, with deep expertise in **Vector Search (kNN)**, **LLM integration (OpenAI)**, and high-load microservices. Significant experience in leading complex migrations and building automated moderation/anti-spam systems. Entrepreneurial mindset with previous experience as CTO and CEO.
...
**Web & Mobile:** React, Angular, TypeScript, JS, HTML/CSS, Kotlin (Android), Swift (iOS).
**Legacy & Systems:** .NET Framework (C#), Java, C++, Borland Delphi.
**Specialized:** Automation (Selenium), SonarQube, Blockchain Security, PLC Programming (Delta/Omron), POS Terminals (Verifone, Ingenico, PAX).
...
|:--|:--|
|Position:| Senior Backend Developer|
|Activity in organizations:| **Vector Search & AI:** Implemented high-performance Vector Search using kNN and freshness rescoring. Integrated OpenAI Embeddings for semantic search capabilities.|
|| **Moderation Systems:** Developed advanced automated moderation and spam detection engines using complex pattern matching and Unicode normalization.|
|| **Modernization:** Led the migration of high-load legacy Python services to Golang, improving performance and reducing technical debt.|
|| **Architecture:** Designing and supporting scalable microservices architecture for major platforms (999.md ecosystem).|
...
|Organization:| Luxury Air Travel LLC |
|:--|:--|
|Position:| CTO|
|Activity in organizations:| Development and support of advanced software. Support for CRM. Support for stable operation of systems. Team leader for 10 people who built ATS.|
|Period:| March 2018 - June 2020|

|Organization:| LibreApp |
|:--|:--|
|Position:| CEO & Founder |
|Activity in organizations:| Software development, business development, and overall strategy. Managed various custom software projects.|
|Period:| September 2009 - November 2019|
...
|:---|:---|:---|
| 3D print Kaluga | Director / Founder | 2014 – 2017 |
| LLC NEOSVET | Account Manager | 2014 – 2015 |
| LLC KITEZH | Realtor's Assistant | 2014 |
| Prom Intellect LLC | Deputy CEO | 2013 – 2014 |
| KNIITMU Kaluga | Technician | 2011 – 2012 |
...
## **Conferences & Speeches**
  ...
  |            | Chisinau                                                                  |
  |:-----------|:--------------------------------------------------------------------------|
  | Theme      | AI Agents in Action                                                       |
  | AI Seminar | 2025                                                                      |
  | Link       | https://www.linkedin.com/posts/simpals_sharing-knowledge-ai-agents-in-action-activity-7350430711104815105-hjhB |
  | Status     | Success                                                                   |

  |                       | Chisinau                                                                  |
  |:----------------------|:--------------------------------------------------------------------------|
  | Theme                 | Pandora’s Box: AI in Software Development                                 |
  | Sigmoid Workshop      | 2025                                                                      |
  | Link                  | https://www.linkedin.com/posts/sigmoid_le-mul%C8%9Bumim-tuturor-participan%C8%9Bilor-care-ugcPost-7288193881878188032-3Ad1?utm_source=share&utm_medium=member_desktop&rcm=ACoAACqrY7wBDh0btRULqzIo5Oo6_u6C57h1xro |
  | Status                | Success                                                                   |

  |                       | Chisinau                                                                  |
  |:----------------------|:--------------------------------------------------------------------------|
  | Theme                 | Discussion panel: The Future Developer: Skills and Roles in an AI-Augmented Workforce |
  | Moldova DevCon 2024   | 2024                                                                      |
  | Link                  | https://www.linkedin.com/posts/vasilii-bologov_mdc24-activity-7258491084161368065-mTpl |
  | Status                | Success                                                                   |

  |                     | Chisinau                                                                  |
  |:--------------------|:--------------------------------------------------------------------------|
  | Theme               | Managing technical debt and modernizing old services                       |
...
## **Education:**
  ...
  |university |Branch of Moscow State Technical University N.E. Bauman (BMSTU), Kaluga|
  |:--|:--|
  |studying time| 2009 - 2015|
  |direction of study |Faculty of Electronics, Informatics and Management. Department of Computer Science.|
